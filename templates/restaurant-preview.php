<form method="post" id="restaurant_preview" action="<?php echo esc_url( $form->get_action() ); ?>">
    <div class="restaurant_listing_preview_title">
        <input type="submit" name="continue" id="restaurant_preview_submit_button" class="button listings-jobs-button-submit-listing" value="<?php echo apply_filters( 'submit_restaurant_step_preview_submit_text', __( 'Submit Listing', 'listings-jobs' ) ); ?>" />
