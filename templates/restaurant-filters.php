...
<?php do_action( 'listings_restaurants_job_filters_before', $atts ); ?>

<form class="job_filters">
	<?php do_action( 'listings_restaurants_job_filters_start', $atts ); ?>

	<div class="search_jobs">
		<?php do_action( 'listings_restaurants_job_filters_search_jobs_start', $atts ); ?>
		...
		<?php do_action( 'listings_restaurants_job_filters_search_jobs_end', $atts ); ?>
	</div>

	<?php do_action( 'listings_restaurants_job_filters_end', $atts ); ?>
</form>

<?php do_action( 'listings_restaurants_job_filters_after', $atts ); ?>
